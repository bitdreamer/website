<?php
   // CalReview.php
   // Show calendar for just one day, and put up the menu 
   // $_GET['theDate'] should be set.
...
<?php
   ...
   function dayForReview( $personID )
   {
      ...
      if ( noerror( $r5 ) )
	  {
	     ...
	     echo "<table border='2'>\n";
		 echo "<tr> ";
		 echo "<tr> <td colspan='7' style='text-align:center'> <b> Calendar Review for day = $gotTheDate </b> </td></tr>\n";
		 ...
		 for ( $i=0; $i<$nr; $i++ )
		 {
	        ...
	        //if ($startDate != $lastDate )  { echo "<tr> <td colspan='2'> $startDate </td> </tr>\n";  $lastDate=$startDate; }
			echo "   <tr>\n";
